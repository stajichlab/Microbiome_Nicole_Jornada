...
author: "Nat Pombubpa"
date: "Updated on January 4, 2019"
...
```{r}
pcca + scale_colour_manual(values = c("Creosote" = "red","Grassland" = "darkolivegreen4","Mesquite" = "green", "Playa" = "blue", "Tarbush" = "purple"))
```
...
```{r warning=FALSE}
pcca.envfit + scale_colour_manual(values = c("Creosote" = "blue","Grassland" = "darkolivegreen4","Mesquite" = "green", "Playa" = "red", "Tarbush" = "purple"))
```
