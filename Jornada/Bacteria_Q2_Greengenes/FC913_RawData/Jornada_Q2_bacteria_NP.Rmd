---
title: "Jornada_Q2_bacteria Greengenes"
author: "Nat Pombubpa"
...
```{r}
otu = read.table(file="JornadaBacQ2FWLEgg515806.otu_table.fix.txt", header=T, sep='\t')
```
...
```{r warning=FALSE}
otus <- read.table("JornadaBacQ2FWLEgg515806.otu_table.fix.txt",
...
```{r}
write.csv(Filtered_OTUs_table, file="Filtered_ASVs_table_Greengenes.csv")
```
...
```{r}
write.csv(Filtered_TAX_table, file="Filtered_TAX_table_Greengenes.csv")
```
